...
MESSAGES = {
    'Include previously deleted accounts for recreation in the preview.': {'de': 'Bereits gelöschte Konten zur erneuten Anlage in die Vorschau aufnehmen.', 'fr': 'Inclure les comptes supprimés à recréer dans l’aperçu.'},
    'Recreated accounts receive new IDs and the profile, password and access status from the import file. Old sessions and references are not restored.': {'de': 'Erneut angelegte Konten erhalten neue IDs sowie Profil, Passwort und Zugangsstatus aus der Importdatei. Alte Sitzungen und Verknüpfungen werden nicht wiederhergestellt.', 'fr': 'Les comptes recréés reçoivent de nouveaux identifiants et le profil, le mot de passe et l’état d’accès du fichier. Les anciennes sessions et références ne sont pas restaurées.'},
    'Recreate deleted account': {'de': 'Gelöschtes Konto erneut anlegen', 'fr': 'Recréer le compte supprimé'},
    'Confirm recreation of the deleted accounts shown in this preview.': {'de': 'Die in dieser Vorschau gezeigten gelöschten Konten ausdrücklich erneut anlegen.', 'fr': 'Confirmer la recréation des comptes supprimés affichés dans cet aperçu.'},
    ...
    'Delete user': {"de": 'Benutzer löschen', "fr": 'Supprimer l’utilisateur'},
    'Permanently delete user': {"de": 'Benutzer endgültig löschen', "fr": 'Supprimer définitivement l’utilisateur'},
    'Permanently delete this disabled account?': {"de": 'Dieses deaktivierte Benutzerkonto endgültig löschen?', "fr": 'Supprimer définitivement ce compte désactivé ?'},
    'The profile, password, sessions, account codes and associated account mail records will be removed. This cannot be undone without a backup.': {"de": 'Profil, Passwort, Sitzungen, Kontocodes und zugehörige Kontonachrichten werden entfernt. Dies kann nur mit einer Sicherung rückgängig gemacht werden.', "fr": 'Le profil, le mot de passe, les sessions, les codes et les courriels du compte seront supprimés. Seule une sauvegarde permet de les restaurer.'},
    'Sessions': {"de": 'Sitzungen', "fr": 'Sessions'},
    'Account codes': {"de": 'Kontocodes', "fr": 'Codes du compte'},
    'Account mail records': {"de": 'Kontonachrichten', "fr": 'Courriels du compte'},
    'Import identities retained to prevent recreation': {"de": 'Importsperren gegen erneute Anlage bleiben erhalten', "fr": 'Identités d’importation conservées contre la recréation'},
    'Audit records remain without profile data. Existing backups and exports are not changed.': {"de": 'Audit-Einträge bleiben ohne Profildaten erhalten. Bestehende Sicherungen und Exporte werden nicht verändert.', "fr": 'Le journal reste sans données de profil. Les sauvegardes et exports existants ne sont pas modifiés.'},
    'Yes, permanently delete this user.': {"de": 'Ja, diesen Benutzer endgültig löschen.', "fr": 'Oui, supprimer définitivement cet utilisateur.'},
    'Only a disabled account other than your own can be deleted.': {"de": 'Nur ein deaktiviertes fremdes Benutzerkonto kann gelöscht werden.', "fr": 'Seul un compte désactivé autre que le vôtre peut être supprimé.'},
    'This account owns files. Deletion is blocked to preserve their ownership.': {"de": 'Dieses Konto besitzt Dateien. Die Löschung ist gesperrt, damit die Zuordnung erhalten bleibt.', "fr": 'Ce compte possède des fichiers. Suppression bloquée pour conserver leur propriétaire.'},
    'Unreviewed plugin or database references prevent account deletion.': {"de": 'Ungeprüfte Plugin- oder Datenbankverknüpfungen verhindern die Kontolöschung.', "fr": 'Des références non vérifiées empêchent la suppression du compte.'},
    'Other mail records refer to this account. Deletion is blocked.': {"de": 'Weitere Nachrichten verweisen auf dieses Konto. Die Löschung ist gesperrt.', "fr": 'D’autres courriels font référence à ce compte. Suppression bloquée.'},
    'Mail delivery is in progress or uncertain. Resolve it before deleting this account.': {"de": 'Ein Versand läuft oder sein Ergebnis ist ungeklärt. Vor der Kontolöschung zuerst den Versand klären.', "fr": 'Un envoi est en cours ou incertain. Résolvez-le avant la suppression.'},
    'The deletion confirmation has expired or is invalid. Review the account again.': {"de": 'Die Löschbestätigung ist abgelaufen oder ungültig. Das Konto erneut prüfen.', "fr": 'La confirmation a expiré ou est invalide. Vérifiez de nouveau le compte.'},
    'The account or its references changed. Review the deletion again.': {"de": 'Das Konto oder seine Verknüpfungen wurden geändert. Die Löschung erneut prüfen.', "fr": 'Le compte ou ses références ont changé. Vérifiez de nouveau la suppression.'},
    'Please confirm that this account should be permanently deleted.': {"de": 'Bitte die endgültige Löschung dieses Kontos bestätigen.', "fr": 'Confirmez la suppression définitive de ce compte.'},
    'User deleted.': {"de": 'Benutzer gelöscht.', "fr": 'Utilisateur supprimé.'},
    'Account deletion failed. No data was deleted.': {"de": 'Kontolöschung fehlgeschlagen. Es wurden keine Daten gelöscht.', "fr": 'Échec de la suppression. Aucune donnée supprimée.'},
    'Previously imported account was deleted': {"de": 'Bereits importiertes Konto wurde gelöscht', "fr": 'Le compte déjà importé a été supprimé'},
    'user.deleted': {"de": 'Benutzer gelöscht', "fr": 'Utilisateur supprimé'},
    'Invalid user ID counter.': {"de": 'Ungültiger Benutzer-ID-Zähler.', "fr": 'Compteur d’utilisateurs invalide.'},
    'User ID limit reached.': {"de": 'Benutzer-ID-Grenze erreicht.', "fr": 'Limite des identifiants atteinte.'},
