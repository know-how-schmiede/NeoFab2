# Nächste Schritte für das Core-System – Stand 0.1.7
...
|---|---|---|
| 0 | Plugin-Vertrag, Rollen und minimale Datei-Schnittstellen vorziehen (N01, U06, S10) | Mehrere Plugin-Rechte, Besitzerprüfung, Navigation, Aktivierung/Deaktivierung und sichere Upload-/Download-Zugriffe mit Testplugins nachweisen. `employee` entspricht `staff`. Noch keine Fachfunktionen. |
...
Nach dem übernommenen Planungsgespräch ist zunächst Paket 0 vorgesehen:
Plugin-Vertrag, Rollen und minimale Datei-Schnittstellen für das spätere
Referenzplugin festigen. Danach bleibt Paket 1 mit dem Versanddienst Voraussetzung
