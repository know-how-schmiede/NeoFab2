# NeoFab2 v0.1.16 – Installation und Entwicklung

Neu in 0.1.16: [Core-Oberfläche und Einstellungen](Core_Oberflaeche_und_Einstellungen.md) mit öffentlichen Seiten, Zeitzone und Einstellungsübertragung. Keine neue Migration.
...
Voraussetzung: v0.1.16 wurde manuell in GitHub Desktop committed und auf den
...
Die Anwendungsversionsnummer dieses Arbeitspakets ist `0.1.16`;
...
Erwartet: Version 0.1.16, HTTP-/HTTPS-Hinweis und vorhandene Admin-E-Mails. Falls
