# NeoFab2 v0.1.21 – Installation und Entwicklung

Neu in 0.1.21: [Benutzerimport trotz einzelner Konflikte](Core_Benutzerimport.md) nach ausdrücklicher Bestätigung. Konfliktkonten bleiben unverändert; keine neue Migration, Schema weiterhin `0013_user_deletion`.
...
Voraussetzung: v0.1.21 wurde manuell in GitHub Desktop committed und auf den
...
Die Anwendungsversionsnummer des aktuellen Stands ist `0.1.21`;
