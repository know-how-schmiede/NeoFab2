# NeoFab2 v0.1.17 – Installation und Entwicklung

Neu in 0.1.17: [Datei- und Plugin-Dienstverträge](Core_Plugin_Dienstvertraege.md) mit deklarierten Plugin-Einstellungen, gemeinsamen Dateitransaktionen und dokumentierten Löschgrenzen. Keine neue Migration.
...
Voraussetzung: v0.1.17 wurde manuell in GitHub Desktop committed und auf den
...
Die Anwendungsversionsnummer dieses Arbeitspakets ist `0.1.17`;
...
Erwartet: Version 0.1.17, HTTP-/HTTPS-Hinweis und vorhandene Admin-E-Mails. Falls
