...
Voraussetzung: 0.1.13 wurde vom Benutzer manuell committed und auf den verwendeten
...
Erwartet: Version `0.1.13` und `Database and schema ready.`. Die explizite Migration
