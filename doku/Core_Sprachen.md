...
Voraussetzung: 0.1.10 wurde vom Benutzer manuell committed und auf den verwendeten
...
Erwartet: Version `0.1.10` und `Database and schema ready.`. Die explizite Migration
